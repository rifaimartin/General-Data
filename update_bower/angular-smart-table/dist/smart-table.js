...
ng.module('smart-table', []).run(['$templateCache', function ($templateCache) {
    $templateCache.put('template/smart-table/pagination.html',
        ...
        '<ul class="pagination">'+
          '<li class="page-item"><a class="page-link" ng-click="selectPage(1)"><i class="fa fa-angle-double-left"></i></a></li>' +
          ...
          '<li class="page-item"><a class="page-link" ng-click="selectPage(numPages)"><i class="fa fa-angle-double-right"></i></a></li>' +
        '</ul></nav>');
}]);
...
ng.module('smart-table').controller('stTableController', [
  ...
  function StTableController($scope, $parse, $filter, $attrs) {
    ...
    var tableState = {
      sort: {},
      search: {},
      pagination: { start: 0, totalItemCount: 0,selectPage:1 },
    };
    var filtered;
    ...
    return {
      ...
      link: function (scope, element, attrs, ctrl) {
        ...
        function redraw () {
          ...
          scope.currentPage = paginationState.selectPage;
